            ...
            <div class="col-xxl-9 col-lg-8 col-md-8">
                ...
                <div class="bg-white redious-border p-20 p-sm-30">
                    <form action="{{ route('theme.options') }}" method="post" class="form">@csrf
                        ...
                        <!-- Single Course Admin Settings -->
                        <div class="row mt-4">
                            <div class="pageTitle">
                                <h6 class="sub-title">Single Course & Promo Banner Settings</h6>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-sm-12">
                                <div class="mb-4">
                                    <label class="form-label">Hero Title</label>
                                    <input type="text" name="single_hero_title" value="{{ setting('single_hero_title') }}" class="form-control" placeholder="E.g., Mathematics with Animated Lessons">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-sm-12">
                                <div class="mb-4">
                                    <label class="form-label">Hero Description</label>
                                    <input type="text" name="single_hero_description" value="{{ setting('single_hero_description') }}" class="form-control" placeholder="Short description text">
                                </div>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-sm-12">
                                <div class="mb-4">
                                    <label class="form-label">Promo Banner Title</label>
                                    <input type="text" name="promo_banner_title" value="{{ setting('promo_banner_title') }}" class="form-control" placeholder="E.g., Admission Is Open For The Next Batch...">
                                </div>
                            </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-sm-12">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="promo_banner_btn_text" value="{{ setting('promo_banner_btn_text') }}" class="form-control" placeholder="E.g., APPLY NOW">
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-sm-12">
                                <div class="mb-4">
                                    <label class="form-label">Button Link URL</label>
                                    <input type="text" name="promo_banner_btn_link" value="{{ setting('promo_banner_btn_link') }}" class="form-control" placeholder="https://...">
                                </div>
                            </div>

                            <!-- Success Video Settings -->
                            <div class="pageTitle mt-4">
                                <h6 class="sub-title">Success Video Section Settings</h6>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-sm-12">
                                <div class="mb-4">
                                    <label class="form-label">Success Video Subtitle</label>
                                    <input type="text" name="success_video_subtitle" value="{{ setting('success_video_subtitle') }}" class="form-control" placeholder="E.g., STUDENT SUCCESS">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-sm-12">
                                <div class="mb-4">
                                    <label class="form-label">Success Video Title</label>
                                    <input type="text" name="success_video_title" value="{{ setting('success_video_title') }}" class="form-control" placeholder="E.g., Success Story Of My Students">
                                </div>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-sm-12">
                                <div class="mb-4">
                                    <label class="form-label">Success Video Description</label>
                                    <textarea name="success_video_description" class="form-control" rows="3" placeholder="Short description">{{ setting('success_video_description') }}</textarea>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-sm-12">
                                <div class="mb-4">
                                    <label class="form-label">Success Video Embed URL</label>
                                    <input type="text" name="success_video_url" value="{{ setting('success_video_url') }}" class="form-control" placeholder="E.g., https://www.youtube.com/watch?v=...">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-sm-12">
                                <div class="mb-4">
                                    <label class="form-label">Enroll Button Text</label>
                                    <input type="text" name="success_video_button_text" value="{{ setting('success_video_button_text') }}" class="form-control" placeholder="E.g., ENROLL NOW">
                                </div>
                            </div>
                            @include('backend.common.media-input', [
                                'title' => 'Success Video Banner Image',
                                'name' => 'success_video_image',
                                'col' => 'col-12 mb-4',
                                'size' => '(800x600)',
                                'image' => setting('success_video_image'),
                                'label' => 'Banner Image',
                            ])
                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="pageTitle">
                                <h6 class="sub-title">Home Page Ad Banner Settings</h6>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-sm-12">
                                <div class="mb-4">
                                    <label class="form-label">Ad Banner Link URL</label>
                                    <input type="text" name="home_ad_banner_link" value="{{ setting('home_ad_banner_link') }}" class="form-control" placeholder="E.g., https://example.com/promotion">
                                </div>
                            </div>
                            @include('backend.common.media-input', [
                                'title' => 'Ad Banner Image',
                                'name' => 'home_ad_banner_image',
                                'col' => 'col-12 mb-4',
                                'size' => '(1200x300 or similar wide format)',
                                'image' => setting('home_ad_banner_image'),
                                'label' => 'Banner Image',
                            ])
                        </div>
