            ...
            <div class="col-xl-11 col-lg-12 col-md-12">
                <div class="hero-content" data-aos="fade-up" data-aos-delay="200">
                    ...
                    @if($hero_course->subject)
                        <div class="mb-3">
                            <span class="badge hero-badge-animated" style="background-color: rgba(255,255,255,0.15); color: #2db37c; font-size: 14px; padding: 6px 14px; border-radius: 20px; font-weight: 600; cursor: pointer;">
