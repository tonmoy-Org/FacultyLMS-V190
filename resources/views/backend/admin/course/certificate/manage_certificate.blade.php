    ...
    <script>
        $(document).ready(function() {
            ...
            $('.cert-sync').on('input keyup change', function() {
                ...
                // If course name changed, sync hidden title and body
            ...
            // Watch for changes in media inputs to update signature / seal previews in real time
            ...
            // Periodically check or observe image selections
